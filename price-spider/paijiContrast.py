...
def init_contrast():
	...
	url = "http://127.0.0.1:3001/machine/price/field"
...
def init_model_guarantee_battery():
	...
	url = "http://127.0.0.1:3001/machine/price/model-guarantee-battery/"
	resp = json.loads(requests.get(url).text)
...
def init_guarantee_corr():
	...
	url = "http://127.0.0.1:3001/machine/price/guarantee/"
	resp = json.loads(requests.get(url).text)
...
def init_battery_corr():
	global battery_corr
	url = "http://127.0.0.1:3001/machine/price/battery/"
	resp = json.loads(requests.get(url).text)
...
def init_price_combination():
	...
	url = "http://127.0.0.1:3001/machine/price/price-combination/"
	resp = json.loads(requests.get(url).text)
