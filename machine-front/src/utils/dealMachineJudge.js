...
export function dealMachineJudge(machine, store, operateName) {
  ...
  // // 总库里的机器只能调拨、销售
  // if (store.state.subStorageLocationIdToParentStorageLocationId[machine.storageLocationId] === 3) {
  //   if (['machineDeliver-2', 'addMachineToMarketOrder'].indexOf(operateName) === -1) {
  //     return Promise.resolve({
  //       "code": -1,
  //       message: "该机器位于总库中, 总库里的机器只能调拨、销售"
  //     });
  //   }
  // }
  //
  // if (['addMachineToEnterStorage', 'addMachineToMarketReturnEnterStorage', 'addMachineToMarketReturn'].indexOf(operateName) === -1 && machine.storageLocationId === null) {
  //   return Promise.resolve({
  //     "code": -1,
  //     message: "该机器还没有入库!!!"
  //   });
  ...
  //     })
  //   }
  return Promise.resolve(machineStatusJudge(machine.statusId, operateName, store.state, {}, machine.fixTimes))
  // }
}

function machineStatusJudge(statusId, operateName, state, receiveDialog, fixTimes) {
  ...
  //     })
  //   }
  // } else if (operateName === 'addMachineToFixComplete') {
  //   //往维修完成中添加机器：已确维修项、送修取回、维修中 -> 维修完成
  //   if ([32, 31, 16].indexOf(statusId) === -1) {
  //     return Promise.resolve({
  //       "code": -1,
  ...
  //   //往送外修单中添加机器：已确维修项、送修取回、维修中 -> 待送外修
  //   if ([32, 31, 16].indexOf(statusId) === -1) {
  //     return Promise.resolve({
  //       "code": -1,
  //       "message": "该机器状态是" + state.machineStatusCorr[statusId] + ", 而不是已确定维修项或送修取回中, 不能进行送外修操作",
  ...
  //     })
  //   }
  // } else if (operateName === 'machineDeliver-14') {
  //   // 退回返修：已确定维修项 -> 退回返修转交单中
  //   if ([32].indexOf(statusId) === -1) {
  //     return Promise.resolve({
  //       "code": -1,
  //       "message": "该机器状态是" + state.machineStatusCorr[statusId] + ", 而不是已确定维修项, 不能进行添加到退回返修转交单中",
  //       "receiveDiagLog": receiveDialog
  //     })
  //   }
  //   if (fixTimes === 0) {
  //     return Promise.resolve({
  //       "code": -1,
  //       "message": "该机器没有没有维修过!!!不能添加到退回返修转交单中",
  //       "receiveDiagLog": receiveDialog
  //     })
  //   }
  // } else if (operateName === 'machineDeliver-15') {
  //   // 退回返修：已确定维修项 -> 返修转交单中
  //   if ([32].indexOf(statusId) !== -1) {
  //     return Promise.resolve({
  //       "code": -1,
  //       "message": "该机器状态是" + state.machineStatusCorr[statusId] + ", 而不是已确定维修项, 不能进行添加到返修转交单中",
  //       "receiveDiagLog": receiveDialog
  //     })
  //   }
  //   if (fixTimes === 0) {
  //     return Promise.resolve({
  //       "code": -1,
  //       "message": "该机器没有没有维修过!!!不能添加到返修转交单中",
  //       "receiveDiagLog": receiveDialog
  //     })
  //   }
  // } else if (operateName === 'machineDeliver-10') {
  //   // 维修：已确定维修项 -> 维修转交单中
  //   if ([32].indexOf(statusId) !== -1) {
  //     return Promise.resolve({
  //       "code": -1,
  //       "message": "该机器状态是" + state.machineStatusCorr[statusId] + ", 而不是已确定维修项, 不能进行添加到维修转交单中",
  //       "receiveDiagLog": receiveDialog
  //     })
  //   }
  //   if (fixTimes !== 0) {
