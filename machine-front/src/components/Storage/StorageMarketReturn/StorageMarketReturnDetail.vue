...
import {getMarketReturnEnterStorageReceiptToMachine} from "../../../api/marketReturnEnterStorageApi";
...
export default {
  ...
  methods: {
    initMachines() {
      ...
      getMarketReturnEnterStorageReceiptToMachine(this.currentPage, this.sizes, this.receiptId).then(resp => {
