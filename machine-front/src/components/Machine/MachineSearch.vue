<template>
  <div style="border: 1px solid #409eff; border-radius: 5px; box-sizing: border-box; padding: 5px; margin: 10px 0px">
    ...
    <el-row style="margin-top: 15px;">
      ...
      <el-col :span="4" style="margin-right: 10px;">
        <div>库位：</div>
        <el-select clearable v-model="searchMachine.storageLocationId" size="mini" placeholder="购入渠道">
          <el-option
              v-for="id in Object.keys($store.state.subStorageLocationIdToNameCorr).map(Number)"
    ...
    <el-row style="margin-top: 10px;">
      <el-col :span="7" :offset="17">
        ...
        <el-button size="mini" icon="el-icon-search" type="primary" @click="searchMachines">搜索</el-button>
      </el-col>
    </el-row>
  </div>
</template>
