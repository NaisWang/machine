  ...
  <div class="">
    ...
    <el-dialog
      ...
      <MachineShowDetail :machines="[nowEditMachine]" :paging="false"
                         ...
                         :extra-not-show="['featureDesc', 'paijiBarcode', 'footer', 'operate']"></MachineShowDetail>
      ...
      <el-form label-width="100px">
        ...
        <el-form-item label="拍机堂条码">
          <el-input v-model="paijiBarcode"></el-input>
        </el-form-item>
      </el-form>
  ...
  methods: {
      ...
      if (this.numberInput !== "") {
        ...
        getMachine(1, 10, {"number": this.numberInput}).then(resp => {
          if (resp.data.obj) {
            ...
            resp.data.obj.data[0].editFeatureDesc = []
            _this.nowEditMachine = resp.data.obj.data[0]
            this.initFeatureDesc(resp.data.obj.data[0])
            _this.numberInput = ""
    ...
    submit() {
      this.$confirm('是否确定要提交', '提示', {
        ...
        temp.paijiBarcode = this.paijiBarcode
        modifyMachineFeature([temp]).then(resp => {
          if (resp.data.code === 200) {
            ...
            this.nowEditMachine.paijiBarcode = temp.paijiBarcode
    ...
    hangUp() {
      ...
      this.nowEditMachine.paijiBarcode = this.paijiBarcode
      this.nowEditMachine.operate = {}
