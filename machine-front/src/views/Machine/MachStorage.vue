<template>
  <div>
    <div style="display: flex; justify-content: space-between">
      ...
      <el-button type="primary" icon="el-icon-search" @click="initMachine" :disabled="showAdvanceSearchVisible">搜索
      </el-button>
        ...
        <el-table-column
          ...
          <template #default="scope">
            <el-popover
              ...
              <template #reference>
                <el-button style="width: 80px; text-overflow: ellipsis; overflow: hidden;" v-show="scope.row.describe">
                  {{
                    scope.row.describe
                  }}
                </el-button>
                <el-button style="width: 80px" v-show="!scope.row.describe">无</el-button>
              </template>
              <el-input
                  type="textarea"
                  autosize
